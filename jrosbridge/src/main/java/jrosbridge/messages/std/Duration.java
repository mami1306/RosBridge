package jrosbridge.messages.std;
...
public class Duration extends Message {
	...
	private final jrosbridge.primitives.Duration data;

	/**
	 * Create a new Duration with a default of 0.
	 */
	public Duration() {
		this(new jrosbridge.primitives.Duration());
	}
	 ...
	 */
	public Duration(jrosbridge.primitives.Duration data) {
	 ...
	 */
	public jrosbridge.primitives.Duration getData() {
		return this.data;
	}
	...
	public static Duration fromJsonObject(JsonObject jsonObject) {
		// check the fields
		jrosbridge.primitives.Duration data = jsonObject
				.containsKey(Duration.FIELD_DATA) ? jrosbridge.primitives.Duration
				.fromJsonObject(jsonObject.getJsonObject(Duration.FIELD_DATA))
				: new jrosbridge.primitives.Duration();
