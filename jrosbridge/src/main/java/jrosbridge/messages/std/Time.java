...
public class Time extends Message {
	...
	private final jrosbridge.primitives.Time data;

	/**
	 * Create a new Time with a default of 0.
	 */
	public Time() {
		this(new jrosbridge.primitives.Time());
	}
	 ...
	 */
	public Time(jrosbridge.primitives.Time data) {
	 ...
	 */
	public jrosbridge.primitives.Time getData() {
		return this.data;
	}
	...
	public static Time fromJsonObject(JsonObject jsonObject) {
		// check the fields
		jrosbridge.primitives.Time data = jsonObject
				.containsKey(Time.FIELD_DATA) ? jrosbridge.primitives.Time
