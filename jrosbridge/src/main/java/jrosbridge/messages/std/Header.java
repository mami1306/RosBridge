...
public class Header extends Message {
	...
	private final jrosbridge.primitives.Time stamp;
	 ...
	 */
	public Header() {
		this(0, new jrosbridge.primitives.Time(), "");
	}
	 ...
	 *            The frame ID.
	 */
	public Header(int seq, jrosbridge.primitives.Time stamp,
	 ...
	 */
	public jrosbridge.primitives.Time getStamp() {
		return this.stamp;
	}
	...
	public static Header fromJsonObject(JsonObject jsonObject) {
		...
		jrosbridge.primitives.Time stamp = jsonObject
				.containsKey(Header.FIELD_STAMP) ? jrosbridge.primitives.Time
				.fromJsonObject(jsonObject.getJsonObject(Header.FIELD_STAMP))
				: new jrosbridge.primitives.Time();
