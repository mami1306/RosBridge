...
public class Service {
	...
	/**
	 * A private {@link jrosbridge.callback.ServiceCallback
	...
	private class BlockingCallback implements ServiceCallback {
		 ...
		 * {@link jrosbridge.Service Service} once a response
		 * has been received.
		 * 
		 * @param service
		 *            The {@link jrosbridge.Service Service}
		 ...
		 * {@link jrosbridge.Service Service}.
		 * 
		 * @param response
